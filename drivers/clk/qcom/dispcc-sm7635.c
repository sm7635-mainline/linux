...
static const struct parent_map dispcc_parent_map_7[] = {
	{ P_SLEEP_CLK, 0 },
};

static const struct clk_parent_data dispcc_parent_data_7_ao[] = {
	{ .index = DT_SLEEP_CLK },
};
...
static const struct freq_tbl ftbl_dispcc_mdss_dptx0_aux_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	{ }
};

static struct clk_rcg2 dispcc_mdss_dptx0_aux_clk_src = {
	.cmd_rcgr = 0x8118,
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = dispcc_parent_map_0,
	.freq_tbl = ftbl_dispcc_mdss_dptx0_aux_clk_src,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "dispcc_mdss_dptx0_aux_clk_src",
...
static struct clk_rcg2 dispcc_mdss_dptx0_link_clk_src = {
	.cmd_rcgr = 0x80cc,
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = dispcc_parent_map_4,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "dispcc_mdss_dptx0_link_clk_src",
...
static struct clk_rcg2 dispcc_mdss_dptx0_pixel0_clk_src = {
	.cmd_rcgr = 0x80e8,
	.mnd_width = 16,
	.hid_width = 5,
	.parent_map = dispcc_parent_map_2,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "dispcc_mdss_dptx0_pixel0_clk_src",
...
static struct clk_rcg2 dispcc_mdss_dptx0_pixel1_clk_src = {
	.cmd_rcgr = 0x8100,
	.mnd_width = 16,
	.hid_width = 5,
	.parent_map = dispcc_parent_map_2,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "dispcc_mdss_dptx0_pixel1_clk_src",
		.parent_data = dispcc_parent_data_2,
		.num_parents = ARRAY_SIZE(dispcc_parent_data_2),
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_dp_ops,
...
static const struct freq_tbl ftbl_dispcc_mdss_esc0_clk_src[] = {
...
static struct clk_rcg2 dispcc_mdss_esc0_clk_src = {
	...
	.freq_tbl = ftbl_dispcc_mdss_esc0_clk_src,
	.clkr.hw.init = &(const struct clk_init_data) {
...
static const struct freq_tbl ftbl_dispcc_mdss_mdp_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(85714286, P_DISPCC_PLL0_OUT_MAIN, 3, 0, 0),
	F(100000000, P_DISPCC_PLL0_OUT_MAIN, 3, 0, 0),
	F(200000000, P_DISPCC_PLL0_OUT_MAIN, 3, 0, 0),
	F(342000000, P_DISPCC_PLL0_OUT_MAIN, 3, 0, 0),
	F(402000000, P_DISPCC_PLL0_OUT_MAIN, 3, 0, 0),
	F(535000000, P_DISPCC_PLL0_OUT_MAIN, 3, 0, 0),
	F(600000000, P_DISPCC_PLL0_OUT_MAIN, 3, 0, 0),
	F(630000000, P_DISPCC_PLL0_OUT_MAIN, 3, 0, 0),
	{ }
};
...
static struct clk_rcg2 dispcc_sleep_clk_src = {
	...
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = dispcc_parent_map_7,
	.freq_tbl = ftbl_dispcc_sleep_clk_src,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "dispcc_sleep_clk_src",
		.parent_data = dispcc_parent_data_7_ao,
		.num_parents = ARRAY_SIZE(dispcc_parent_data_7_ao),
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_regmap_div dispcc_mdss_dptx0_link_div_clk_src = {
	.reg = 0x80e4,
	.shift = 0,
	.width = 4,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "dispcc_mdss_dptx0_link_div_clk_src",
		.parent_hws = (const struct clk_hw*[]) {
			&dispcc_mdss_dptx0_link_clk_src.clkr.hw,
		},
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
...
static struct clk_branch dispcc_mdss_accu_clk = {
	.halt_reg = 0xe050,
	...
	.clkr = {
		...
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "dispcc_mdss_accu_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&dispcc_xo_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch dispcc_mdss_ahb1_clk = {
	.halt_reg = 0xa020,
...
static struct clk_branch dispcc_mdss_dptx0_aux_clk = {
	.halt_reg = 0x8048,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x8048,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "dispcc_mdss_dptx0_aux_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&dispcc_mdss_dptx0_aux_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch dispcc_mdss_dptx0_crypto_clk = {
	.halt_reg = 0x803c,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x803c,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "dispcc_mdss_dptx0_crypto_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&dispcc_mdss_dptx0_link_clk_src.clkr.hw,
			},
			.num_parents = 1,
...
static struct clk_branch dispcc_mdss_dptx0_link_clk = {
	.halt_reg = 0x8030,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x8030,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "dispcc_mdss_dptx0_link_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&dispcc_mdss_dptx0_link_clk_src.clkr.hw,
			},
			.num_parents = 1,
...
static struct clk_branch dispcc_mdss_dptx0_link_intf_clk = {
	.halt_reg = 0x8038,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x8038,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "dispcc_mdss_dptx0_link_intf_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&dispcc_mdss_dptx0_link_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch dispcc_mdss_dptx0_pixel0_clk = {
	.halt_reg = 0x8040,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x8040,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "dispcc_mdss_dptx0_pixel0_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&dispcc_mdss_dptx0_pixel0_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch dispcc_mdss_dptx0_pixel1_clk = {
	.halt_reg = 0x8044,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x8044,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "dispcc_mdss_dptx0_pixel1_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&dispcc_mdss_dptx0_pixel1_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch dispcc_mdss_dptx0_usb_router_link_intf_clk = {
	.halt_reg = 0x8034,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x8034,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "dispcc_mdss_dptx0_usb_router_link_intf_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&dispcc_mdss_dptx0_link_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
...
static struct clk_branch dispcc_mdss_mdp1_clk = {
	.halt_reg = 0xa004,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0xa004,
...
static struct clk_branch dispcc_mdss_mdp_lut1_clk = {
	.halt_reg = 0xa010,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0xa010,
...
static struct clk_branch dispcc_mdss_vsync1_clk = {
	.halt_reg = 0xa01c,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0xa01c,
...
static struct clk_regmap *dispcc_sm7635_clocks[] = {
	[DISPCC_MDSS_ACCU_CLK] = &dispcc_mdss_accu_clk.clkr,
	[DISPCC_MDSS_AHB1_CLK] = &dispcc_mdss_ahb1_clk.clkr,
	...
	[DISPCC_MDSS_DPTX0_AUX_CLK] = &dispcc_mdss_dptx0_aux_clk.clkr,
	[DISPCC_MDSS_DPTX0_AUX_CLK_SRC] = &dispcc_mdss_dptx0_aux_clk_src.clkr,
	[DISPCC_MDSS_DPTX0_CRYPTO_CLK] = &dispcc_mdss_dptx0_crypto_clk.clkr,
	[DISPCC_MDSS_DPTX0_LINK_CLK] = &dispcc_mdss_dptx0_link_clk.clkr,
	[DISPCC_MDSS_DPTX0_LINK_CLK_SRC] = &dispcc_mdss_dptx0_link_clk_src.clkr,
	[DISPCC_MDSS_DPTX0_LINK_DIV_CLK_SRC] = &dispcc_mdss_dptx0_link_div_clk_src.clkr,
	[DISPCC_MDSS_DPTX0_LINK_INTF_CLK] = &dispcc_mdss_dptx0_link_intf_clk.clkr,
	[DISPCC_MDSS_DPTX0_PIXEL0_CLK] = &dispcc_mdss_dptx0_pixel0_clk.clkr,
	[DISPCC_MDSS_DPTX0_PIXEL0_CLK_SRC] = &dispcc_mdss_dptx0_pixel0_clk_src.clkr,
	[DISPCC_MDSS_DPTX0_PIXEL1_CLK] = &dispcc_mdss_dptx0_pixel1_clk.clkr,
	[DISPCC_MDSS_DPTX0_PIXEL1_CLK_SRC] = &dispcc_mdss_dptx0_pixel1_clk_src.clkr,
	[DISPCC_MDSS_DPTX0_USB_ROUTER_LINK_INTF_CLK] =
		&dispcc_mdss_dptx0_usb_router_link_intf_clk.clkr,
	[DISPCC_MDSS_ESC0_CLK] = &dispcc_mdss_esc0_clk.clkr,
	[DISPCC_MDSS_ESC0_CLK_SRC] = &dispcc_mdss_esc0_clk_src.clkr,
	[DISPCC_MDSS_MDP1_CLK] = &dispcc_mdss_mdp1_clk.clkr,
	[DISPCC_MDSS_MDP_CLK] = &dispcc_mdss_mdp_clk.clkr,
	[DISPCC_MDSS_MDP_CLK_SRC] = &dispcc_mdss_mdp_clk_src.clkr,
	[DISPCC_MDSS_MDP_LUT1_CLK] = &dispcc_mdss_mdp_lut1_clk.clkr,
	...
	[DISPCC_MDSS_VSYNC1_CLK] = &dispcc_mdss_vsync1_clk.clkr,
...
static const struct qcom_reset_map dispcc_sm7635_resets[] = {
	[DISPCC_MDSS_CORE_BCR] = { 0x8000 },
	[DISPCC_MDSS_CORE_INT2_BCR] = { 0xa000 },
	[DISPCC_MDSS_RSCC_BCR] = { 0xc000 },
};

static const struct regmap_config dispcc_sm7635_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static struct qcom_cc_desc dispcc_sm7635_desc = {
	.config = &dispcc_sm7635_regmap_config,
	.clks = dispcc_sm7635_clocks,
	.num_clks = ARRAY_SIZE(dispcc_sm7635_clocks),
	.resets = dispcc_sm7635_resets,
	.num_resets = ARRAY_SIZE(dispcc_sm7635_resets),
};

static const struct of_device_id dispcc_sm7635_match_table[] = {
	{ .compatible = "qcom,sm7635-dispcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, dispcc_sm7635_match_table);

static int dispcc_sm7635_probe(struct platform_device *pdev)
{
	struct regmap *regmap;

	regmap = qcom_cc_map(pdev, &dispcc_sm7635_desc);
	if (IS_ERR(regmap))
		return PTR_ERR(regmap);

	clk_lucid_ole_pll_configure(&dispcc_pll0, regmap, &dispcc_pll0_config);

	/* Enable clock gating for MDP clocks */
	regmap_update_bits(regmap, 0xf000, 0x10, 0x10); /* DISPCC_MISC_CMD */

	/* Keep some clocks always-on */
	qcom_branch_set_clk_en(regmap, 0xe06c); /* DISPCC_SLEEP_CLK */
	qcom_branch_set_clk_en(regmap, 0xe04c); /* DISPCC_XO_CLK */

	return qcom_cc_really_probe(&pdev->dev, &dispcc_sm7635_desc, regmap);
}

static struct platform_driver dispcc_sm7635_driver = {
	.probe = dispcc_sm7635_probe,
	.driver = {
		.name = "dispcc-sm7635",
		.of_match_table = dispcc_sm7635_match_table,
	},
};

static int __init dispcc_sm7635_init(void)
{
	return platform_driver_register(&dispcc_sm7635_driver);
}
subsys_initcall(dispcc_sm7635_init);

static void __exit dispcc_sm7635_exit(void)
{
	platform_driver_unregister(&dispcc_sm7635_driver);
}
module_exit(dispcc_sm7635_exit);

MODULE_DESCRIPTION("QTI DISPCC SM7635 Driver");
MODULE_LICENSE("GPL");
